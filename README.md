...
| --- | --- | --- | --- |
| 2026-06-26 | Kubernetes / Karmada | [Karmada ScaleX-POD Lab](kubernetes/karmada/) | MiniX kind 기반 Karmada 실험 00~12, role label placement, NoExecute failover, clusterTolerations, WorkloadRebalancer 재균형 |
