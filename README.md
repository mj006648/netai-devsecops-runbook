...
| --- | --- | --- | --- |
| 2026-06-26 | Kubernetes / Upgrade | [TwinX Kubernetes Upgrade Run 2026-06-26](kubernetes/upgrades/twinx-kubernetes-upgrade-run-2026-06-26.md) | 당일 preflight, OTP 임시 해제 결과, 실행 로그, 다음 작업과 중단 기준 |
