...
| 노드 | 실제 플랫폼 / CPU | NUMA | 실장 RAM / 빈 DIMM | 현재 GPU | 신규 x16급 카드 자리 후보¹ |
| --- | --- | ---: | --- | --- | ---: |
| `sv4000-1` | ASUS ESC4000A-E12 / EPYC 9124 16C×1 | 1 | 64 GB×4 = 256 GB / 8 | RTX A6000×2, A100 PCIe 40GB×1 | **1**, Gen5 x16 설계 |
| `sv4000-2` | ASUS ESC4000A-E12 / EPYC 9124 16C×1 | 1 | 64 GB×4 = 256 GB / 8 | L40×2, A100 PCIe 40GB×1 | **1**, Gen5 x16 설계 |
| `rm352-1` | ASRock Rack SPC621D8 보드 / Xeon Silver 4310 12C×1 | 1 | 32 GB×6 = 192 GB / 2 | Quadro RTX 6000×1, A10×1 | **최대 2**, Gen4 x16 보드 슬롯 |
| `rm352-2` | ASRock Rack SPC621D8 보드 / Xeon Silver 4310 12C×1 | 1 | 32 GB×6 = 192 GB / 2 | Quadro RTX 6000×1, A10×1 | **최대 1**, Gen4 x16 보드 슬롯 |
| `l40s` | ASUS ESC8000A-E12 / EPYC 9254 24C×2 | 2 | 64 GB×12 = 768 GB / 12 | L40S×8 | **0**: GPU 베이 8/8 사용 |
