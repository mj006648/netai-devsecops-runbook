...
| 2026-06-26 | Upgrade run | TwinX v1.35.4 업그레이드 완료 노드, edgebox 보류, Kubespray no-drain 패치, Ceph/Harbor/OTP 남은 작업 | [TwinX Kubernetes Upgrade Run 2026-06-26](upgrades/twinx-kubernetes-upgrade-run-2026-06-26.md) |
