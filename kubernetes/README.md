...
| --- | --- | --- | --- |
| 2026-06-29 | Cluster lifecycle | TwinX control1 단일 control-plane 전환 완료, control2/control3 제거, GPU Operator/NFD/DRA controller sv4000-1 이동, Kubespray inventory 정리 | [TwinX Single Control Plane Transition](cluster-lifecycle/twinx-single-control-plane-transition-2026-06-29.md) |
