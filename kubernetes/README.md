...
| --- | --- | --- | --- |
| 2026-06-26 | Upgrade run | TwinX 당일 업그레이드 실행 로그, preflight, OTP 임시 해제 결과 | [TwinX Kubernetes Upgrade Run 2026-06-26](upgrades/twinx-kubernetes-upgrade-run-2026-06-26.md) |
