...
[통합 학습 안내](../../../learning/README.md)는 전기·비트부터 네 교재를 연결한다. 기존 기초를 알면 아래 연구 단계로 바로 진행하고, 처음이면 [운영체제 입문](../../../linux/learning/linux-kernel/01-programs-processes-and-shell.md)과 [네트워크 기초](../../networking/networking-foundations/README.md)를 먼저 읽는다. 커널·가상 메모리·eBPF·패킷 경로는 이제 별도 교재 본문에서 배우고, 이 장에서는 연구 질문과 평가로 연결한다.
