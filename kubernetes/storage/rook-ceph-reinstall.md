...
- [ ] 먼저 node networking이 정상인지 확인한다.
      ([`kubernetes/networking/mtu-cilium.md`](../networking/mtu-cilium.md),
      [`kubernetes/networking/rm352-pod-comms.md`](../networking/rm352-pod-comms.md))

## 1단계 — 영향 노드의 stale storage state 제거

[`kubernetes/storage/lv-preparation.md`](lv-preparation.md)를 따른다.
...
- 관련 문서: [`kubernetes/storage/lv-preparation.md`](lv-preparation.md),
  [`kubernetes/incidents/cluster-cascade.md`](../incidents/cluster-cascade.md)
