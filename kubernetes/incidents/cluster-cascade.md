...
3. **그다음 스토리지다.** [`kubernetes/storage/rook-ceph-reinstall.md`](../storage/rook-ceph-reinstall.md)
   절차를 사용하고, 재설치 전에 [`kubernetes/storage/lv-preparation.md`](../storage/lv-preparation.md)로
   stale LVM을 먼저 지운다.
