...
- [Kueue 관측/알림 runbook](./runbooks/kueue-observability.md)
...
- [`experiments/2026-06-29-28-argocd-karmada-kueue.md`](./experiments/2026-06-29-28-argocd-karmada-kueue.md)
  - ArgoCD가 Karmada API Server로 sync한 Job을 Karmada가 datax로 전파하고, datax Kueue가 admission을 제어하는 end-to-end 구조 검증
  - ArgoCD Synced/Karmada FullyApplied와 Kueue pending/admitted 상태를 함께 봐야 함을 확인
- [`experiments/2026-06-29-29-kueue-observability.md`](./experiments/2026-06-29-29-kueue-observability.md)
  - Kueue 관측/알림 runbook 작성 및 pending/admitted snapshot 재현
  - GitOps 실패, placement 실패, member apply 실패, Kueue quota 대기, Kueue controller 장애를 분리하는 기준 정리
- [`experiments/2026-06-30-30-kueue-controller-recovery.md`](./experiments/2026-06-30-30-kueue-controller-recovery.md)
  - Kueue controller/webhook 중단 시 Karmada Work apply가 실패하고 ResourceBinding `FullyApplied=False`가 되는지 검증
  - controller 복구만으로 즉시 재시도되지 않을 수 있어 Karmada resource update로 빠른 수렴을 유도하는 절차 기록
- [`experiments/2026-06-30-31-kueue-quota-change.md`](./experiments/2026-06-30-31-kueue-quota-change.md)
  - Kueue quota 증가로 pending Job이 admitted/Running으로 전환되는지 검증
  - quota 감소가 이미 admitted/running 중인 Job을 즉시 evict/suspend하지 않는다는 운영 주의점 기록
- [`experiments/2026-07-01-32-scheduler-estimator-install.md`](./experiments/2026-07-01-32-scheduler-estimator-install.md)
...
karmada/
  ...
  notes/
    ...
    scalex-pod-operating-model.md    # ScaleX-POD 최종 운영 모델
  experiments/
    README.md                                           # 실험 진행표
    ...
    2026-06-29-28-argocd-karmada-kueue.md                # ArgoCD/Karmada/Kueue 통합
    2026-06-29-29-kueue-observability.md                 # Kueue 관측/알림
  argocd/
  ...
  manifests/
    ...
    demo-argocd-kueue-datax/         # ArgoCD -> Karmada -> DataX -> Kueue YAML
```
