...
kubectl --context kind-twinx apply \
  -f kubernetes/karmada/manifests/demo-override-platform/member-storageclasses/twinx-storageclass.yaml

kubectl --context kind-edgex apply \
  -f kubernetes/karmada/manifests/demo-override-platform/member-storageclasses/edgex-storageclass.yaml

kubectl --context kind-datax apply \
  -f kubernetes/karmada/manifests/demo-override-platform/member-storageclasses/datax-storageclass.yaml

kubectl --context kind-poolx apply \
  -f kubernetes/karmada/manifests/demo-override-platform/member-storageclasses/poolx-storageclass.yaml
```
...
```text
kubernetes/karmada/manifests/demo-override-platform/
...
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply --dry-run=client \
  -f kubernetes/karmada/manifests/demo-override-platform/00-namespace.yaml \
  -f kubernetes/karmada/manifests/demo-override-platform/10-pvc.yaml \
  -f kubernetes/karmada/manifests/demo-override-platform/20-deployment.yaml \
  -f kubernetes/karmada/manifests/demo-override-platform/30-service.yaml \
  -f kubernetes/karmada/manifests/demo-override-platform/40-override-image.yaml \
  -f kubernetes/karmada/manifests/demo-override-platform/41-override-storageclass.yaml \
  -f kubernetes/karmada/manifests/demo-override-platform/50-propagation-policy.yaml
```
