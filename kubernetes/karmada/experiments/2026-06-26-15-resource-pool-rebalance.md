...
```text
kubernetes/karmada/manifests/demo-resource-pool-rebalance/
  00-namespace.yaml
  10-deployment.yaml
  20-service.yaml
...
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply --dry-run=client \
  -f kubernetes/karmada/manifests/demo-resource-pool-rebalance/
```
...
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply \
  -f kubernetes/karmada/manifests/demo-resource-pool-rebalance/00-namespace.yaml \
  -f kubernetes/karmada/manifests/demo-resource-pool-rebalance/10-deployment.yaml \
  -f kubernetes/karmada/manifests/demo-resource-pool-rebalance/20-service.yaml \
  -f kubernetes/karmada/manifests/demo-resource-pool-rebalance/30-propagation-policy.yaml
```
...
```bash
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply \
  -f kubernetes/karmada/manifests/demo-resource-pool-rebalance/40-workload-rebalancer.yaml
```
