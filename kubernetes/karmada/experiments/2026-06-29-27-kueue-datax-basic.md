...
```text
kubernetes/karmada/manifests/demo-kueue-datax/
```
...
```bash
kubectl --context kind-datax apply --dry-run=server   -f kubernetes/karmada/manifests/demo-kueue-datax/member/
```
...
```bash
kubectl --context kind-datax apply   -f kubernetes/karmada/manifests/demo-kueue-datax/member/00-namespace.yaml

kubectl --context kind-datax apply --dry-run=server   -f kubernetes/karmada/manifests/demo-kueue-datax/member/10-kueue-queues.yaml

kubectl --context kind-datax apply   -f kubernetes/karmada/manifests/demo-kueue-datax/member/10-kueue-queues.yaml
```
...
```bash
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply   -f kubernetes/karmada/manifests/demo-kueue-datax/karmada/00-namespace.yaml

kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply   -f kubernetes/karmada/manifests/demo-kueue-datax/karmada/01-cluster-propagation-policy-namespace.yaml   -f kubernetes/karmada/manifests/demo-kueue-datax/karmada/10-job-a.yaml   -f kubernetes/karmada/manifests/demo-kueue-datax/karmada/11-job-b.yaml   -f kubernetes/karmada/manifests/demo-kueue-datax/karmada/30-propagation-policy.yaml
```
...
```bash
kubectl --kubeconfig ~/.kube/karmada-apiserver.config delete   -f kubernetes/karmada/manifests/demo-kueue-datax/karmada/   --ignore-not-found

kubectl --context kind-datax delete   -f kubernetes/karmada/manifests/demo-kueue-datax/member/   --ignore-not-found
```
