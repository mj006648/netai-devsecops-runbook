...
```text
kubernetes/karmada/argocd/applications/karmada-spread-constraints.yaml
```
...
spec:
  ...
  source:
    ...
    targetRevision: main
    path: kubernetes/karmada/manifests/demo-spread-constraints
  destination:
    server: https://karmada-apiserver.karmada-system.svc:5443
...
```text
source path: kubernetes/karmada/manifests/demo-spread-constraints
```
...
kubectl --context kind-tower apply \
  -f kubernetes/karmada/argocd/applications/karmada-spread-constraints.yaml
```
