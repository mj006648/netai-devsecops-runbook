...
8. TowerX 단일 ArgoCD 기준 tower-k8s/scalex-federation/*-k8s repo split
```
...
```text
1. 실제 tower-k8s/scalex-federation/twinx-k8s/datax-k8s/edgex-k8s repo 생성과 TowerX 단일 ArgoCD bootstrap
