...
```text
kubernetes/multicluster/karmada/manifests/demo-scheduler-estimator/
  00-namespace.yaml
...
```bash
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply \
  -f kubernetes/multicluster/karmada/manifests/demo-scheduler-estimator/11-disabled-weighted-deployment.yaml \
  -f kubernetes/multicluster/karmada/manifests/demo-scheduler-estimator/21-disabled-weighted-service.yaml \
  -f kubernetes/multicluster/karmada/manifests/demo-scheduler-estimator/31-disabled-weighted-propagation-policy.yaml
```
