...
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply \
  -f kubernetes/multicluster/karmada/manifests/demo-spread-constraints/
```

자세한 기록: `kubernetes/multicluster/karmada/experiments/2026-06-27-17-spread-constraints.md`
