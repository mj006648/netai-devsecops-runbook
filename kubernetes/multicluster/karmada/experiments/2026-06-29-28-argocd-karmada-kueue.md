...
```text
kubernetes/multicluster/karmada/manifests/demo-argocd-kueue-datax/
kubernetes/multicluster/karmada/argocd/applications/karmada-kueue-datax.yaml
```
...
source path: kubernetes/multicluster/karmada/manifests/demo-argocd-kueue-datax/karmada
...
kubectl --context kind-datax apply --dry-run=server -f kubernetes/multicluster/karmada/manifests/demo-argocd-kueue-datax/member/10-kueue-queues.yaml
