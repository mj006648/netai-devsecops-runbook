...
```text
kubernetes/multicluster/karmada/manifests/demo-argocd-prune-rollback/
  00-namespace.yaml
  10-deployment.yaml
  20-service.yaml
...
```text
kubernetes/multicluster/karmada/argocd/applications/karmada-prune-rollback.yaml
```
...
spec:
  source:
    ...
    targetRevision: main
    path: kubernetes/multicluster/karmada/manifests/demo-argocd-prune-rollback
  destination:
...
kubectl --context kind-tower apply \
  -f kubernetes/multicluster/karmada/argocd/applications/karmada-prune-rollback.yaml
...
```bash
git rm kubernetes/multicluster/karmada/manifests/demo-argocd-prune-rollback/20-service.yaml
...
```bash
git add kubernetes/multicluster/karmada/manifests/demo-argocd-prune-rollback/20-service.yaml
