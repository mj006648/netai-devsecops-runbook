...
kubectl --kubeconfig ~/.kube/karmada-apiserver.config apply \
  -f kubernetes/multicluster/karmada/manifests/demo-noexecute-toleration-scope/
```
...
자세한 기록: `kubernetes/multicluster/karmada/experiments/2026-06-26-10-noexecute-toleration-scope.md`
