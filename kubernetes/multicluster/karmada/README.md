...
| Nessie | `scalex.io/data/nessie` | `smartx-k8s/apps/nessie` | DataX | lakehouse catalog |
| Trino | `scalex.io/data/trino` | `smartx-k8s/apps/trino` | DataX | query engine |
