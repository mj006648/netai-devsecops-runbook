...
| --- | --- | --- | --- |
| 2026-07-01 | Cilium / Hubble | [TwinX Cilium GitOps 및 Hubble 전환 계획](twinx-cilium-gitops-hubble-plan-2026-06-29.md) | Kubespray를 배제하고 Cilium 1.17.3 상태 그대로 ArgoCD GitOps 준비, 이후 ownership 전환과 Hubble relay/metrics 활성화 |
